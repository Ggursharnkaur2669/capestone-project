<?php 
	...
	if(isset($_GET['bid'])) {
        ...
        $q = "SELECT * FROM inventory WHERE pizza_id = $bid";
...
// checking form submission and santizing the strings
    if(isset($_POST['submit']))
    {
        ...
        if(empty($error))
	 	{
	 		echo $pizza_name;
            $q = "INSERT INTO orders VALUES ('','$pizza_name','$firstname','$lastname','$address','$payment','$amount')";
	 		$insert_query = mysqli_query($dbc,$q);
            echo mysqli_error($dbc);

	 		$query = mysqli_query($dbc, "SELECT * FROM inventory WHERE id = $id");
            ...
            $newQuantity = $quantity - 1;
	 		...
	 		$update = mysqli_query($dbc,"UPDATE inventory SET Quantity = '$newQuantity' WHERE ID='$id'");
  ...
  <div class="container-fluid">
    ...
    <div class=" text-center"><br><br>
        <div class='img_disp' style=" height: 100%; width: 100%; ">
            <img src="<?php echo $Image; ?>" style="width:250px;height:400px; ">
        </div>
