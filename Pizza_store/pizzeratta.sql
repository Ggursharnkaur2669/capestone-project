...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2020 at 09:43 PM
...
INSERT INTO `orders` (`id`, `Pizza_name`, `firstname`, `lastname`, `address`, `payment`, `Price`) VALUES
(5, '', 'vishal', 'kumar', '1224555', 'Credit card', 0),
(6, '', 'abc', 'def', 'dfkvd', 'Credit card', 0),
(7, '', 'Mandeep', 'Kaur', 'sgssgsgsgsg', 'Credit card', 0),
(8, '', 'gcgh', 'ddtg', 'cghc', 'Credit card', 0);
